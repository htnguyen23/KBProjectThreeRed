...
public class Frontend {
  ...
  /**
   * Runs the frontend and allows the user to interact with the program.
   * 
   * @param back - the backend that runs the shortest path algorithm.
   */
  ...
  /**
   * Prints the entire list of national parks. Also allows the user to pick a national park to visit
  ...
  private void printList() {
    ...
    // asks the user if they want to see the path to any of these parks
    ...
    do {
      ...
      if (!userInput.equalsIgnoreCase("x")) {
        try {
          ...
          // asks the user if they want to save this particular path to their list of itineraries
  ...
  /**
   * Runs the random suggestion mode. The program randomly chooses a national park from the list and
  ...
  private void randomSuggestion() {
    ...
    // asks the user if they want to save this particular search to their saved itineraries
    System.out.println("\nWould you like to save this itinerary to your list?"
        + "\n___________________________________________" + "\nY - Yes! This looks fun!"
        + "\nx - I want to go back to the main menu.");
    String userInput = "";
  ...
  private void displaySavedPlans() {
    ...
    // asks the user if they want to remove any of the saved itineraries
    ...
    do {
      ...
      switch (userInput) {
        case "1":
          // remove first
          if (!itinerary.isEmpty() && Integer.parseInt(userInput) <= itinerary.size()) { // IM:
                                                                                         // added
                                                                                         // conditional
                                                                                         // to check
                                                                                         // if
